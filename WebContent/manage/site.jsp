	...
	<div class="layuimini-container">
		<div class="layuimini-main">
			...
			<script type="text/html" id="currentTableBar">
				<a class="layui-btn layui-btn-xs layui-btn-normal data-count-edit" lay-event="view">余票</a>
		...
		<div class="layuimini-main">
			<form class="layui-form" action="" lay-filter="aexample">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" id="atime1" name="atime" lay-verify="required"
							autocomplete="off" placeholder="请输入到站时间" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">历时</label>
					<div class="layui-input-block">
						<input type="text" name="stime" lay-verify="required"
							autocomplete="off" placeholder="请输入历时分钟" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
		...
		<div class="layuimini-main">
			<form class="layui-form" action="" lay-filter="uexample">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">到站时间</label>
					<div class="layui-input-block">
						<input type="text" id="atime2" name="atime" lay-verify="required"
							autocomplete="off" placeholder="请输入到站时间" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
	 ...
	 layui.use(['form', 'table','laydate','upload'], function () {
	        var $ = layui.jquery,
	        	...
	        	laydate = layui.laydate;
	       		...
	       		form.verify({
	            	stime1: function (value) {
	            		var time1=$("#atime1").val();
	                    if (time1!='' && value < time1) {
	                        return '发车时间不能小于到达时间';
	                    }
	                }
	                , stime2: function (value) {
	            		var time1=$("#atime2").val();
	                    if (time1!='' && value < time1) {
	                        return '发车时间不能小于到达时间';
	                    }
	                }
        ...
        table.render({
            elem: '#currentTableId',
            url: '<%=Const.ROOT%>site/list?cid=${param.cid}',
            cols: [[
				{field:'id',hide:true,width: 0},
				{width: 80, templet:'#no',title: 'NO', sort: true},
                {templet: '#cid', width: 200, title: '车次'},
                {field: 'sname', width: 200, title: '站点名'},
                {field: 'atime', width: 200, title: '到站时间'},
                {field: 'stime', width: 200, title: '历时(分钟)'},
              ...
              //表单初始赋值
               ...
               setFormValue(obj,data);    
                ...
                layer.confirm('真的删除行么', function (index) {
                    ...
                    $.getJSON('<%=Const.ROOT%>site/delete',{'id':obj.data.id},function(msg) {
  						//console.log(msg);
  						if(msg.code=="0"){
              ...
              form.on('submit(update)', function(message) {
                  ...
                  url:'<%=Const.ROOT%>site/update',
					...
					success : function(msg) {
						...
						if(msg.code=="0"){
							layer.msg(msg.msg, { icon: 6, time: 800},function(){
									//location.href="<%=Const.ROOT%>manage/site.jsp";
